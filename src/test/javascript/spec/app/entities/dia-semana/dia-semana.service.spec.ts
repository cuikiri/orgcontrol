...
describe('Service Tests', () => {
    describe('DiaSemana Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new DiaSemana(0, 'AAAAAAA', 'AAAAAAA', 0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a DiaSemana', async () => {
            ...
            it('should update a DiaSemana', async () => {
                const returnedFromService = Object.assign(
                    {
                        abreviatura: 'BBBBBB',
                        nome: 'BBBBBB',
            ...
            it('should return a list of DiaSemana', async () => {
                const returnedFromService = Object.assign(
                    {
                        abreviatura: 'BBBBBB',
                        nome: 'BBBBBB',
            ...
            it('should delete a DiaSemana', async () => {
