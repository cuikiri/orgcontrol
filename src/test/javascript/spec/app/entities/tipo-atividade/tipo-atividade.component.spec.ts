...
import { TipoAtividadeComponent } from 'app/entities/tipo-atividade/tipo-atividade.component';
...
describe('Component Tests', () => {
    describe('TipoAtividade Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tipoAtividades[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
