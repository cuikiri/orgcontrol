...
import { ExameMedicoComponent } from 'app/entities/exame-medico/exame-medico.component';
...
describe('Component Tests', () => {
    describe('ExameMedico Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.exameMedicos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
