...
describe('Service Tests', () => {
    describe('Materia Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MateriaService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Materia(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should return a list of Materia', async () => {
                const returnedFromService = Object.assign(
                    {
                        abreviatura: 'BBBBBB',
                        nome: 'BBBBBB',
