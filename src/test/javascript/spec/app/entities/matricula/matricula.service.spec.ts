...
describe('Service Tests', () => {
    describe('Matricula Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Matricula(0, currentDate, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Matricula', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        data: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Matricula', async () => {
                const returnedFromService = Object.assign(
                    {
                        data: currentDate.format(DATE_FORMAT),
                        obs: 'BBBBBB'
            ...
            it('should return a list of Matricula', async () => {
                const returnedFromService = Object.assign(
                    {
                        data: currentDate.format(DATE_FORMAT),
                        obs: 'BBBBBB'
            ...
            it('should delete a Matricula', async () => {
