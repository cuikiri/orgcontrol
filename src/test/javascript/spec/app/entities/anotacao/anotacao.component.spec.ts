...
import { AnotacaoComponent } from 'app/entities/anotacao/anotacao.component';
...
describe('Component Tests', () => {
    describe('Anotacao Management Component', () => {
        let comp: AnotacaoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AnotacaoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.anotacaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
