...
import { AvaliacaoEconomicaComponent } from 'app/entities/avaliacao-economica/avaliacao-economica.component';
    ...
    describe('AvaliacaoEconomica Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new AvaliacaoEconomica(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.avaliacaoEconomicas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
