...
describe('Service Tests', () => {
    describe('Unidade Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(UnidadeService);
            httpMock = injector.get(HttpTestingController);

            elemDefault = new Unidade(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Unidade', async () => {
            ...
            it('should return a list of Unidade', async () => {
                const returnedFromService = Object.assign(
                    {
                        nome: 'BBBBBB'
                    },
