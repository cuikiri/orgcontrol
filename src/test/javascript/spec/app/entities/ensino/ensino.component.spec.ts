...
import { EnsinoComponent } from 'app/entities/ensino/ensino.component';
import { EnsinoService } from 'app/entities/ensino/ensino.service';
import { Ensino } from 'app/shared/model/ensino.model';

describe('Component Tests', () => {
    describe('Ensino Management Component', () => {
        let comp: EnsinoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EnsinoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.ensinos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
