...
import { TipoColaboradorComponent } from 'app/entities/tipo-colaborador/tipo-colaborador.component';
...
describe('Component Tests', () => {
    describe('TipoColaborador Management Component', () => {
        let comp: TipoColaboradorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TipoColaboradorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tipoColaboradors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
