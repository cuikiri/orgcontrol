...
import { ConceitoComponent } from 'app/entities/conceito/conceito.component';
...
describe('Component Tests', () => {
    describe('Conceito Management Component', () => {
        let comp: ConceitoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ConceitoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.conceitos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
