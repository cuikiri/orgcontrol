...
import { BiotipoComponent } from 'app/entities/biotipo/biotipo.component';
import { BiotipoService } from 'app/entities/biotipo/biotipo.service';
import { Biotipo } from 'app/shared/model/biotipo.model';

describe('Component Tests', () => {
    describe('Biotipo Management Component', () => {
        let comp: BiotipoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BiotipoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.biotipos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
