...
import { SexoComponent } from 'app/entities/sexo/sexo.component';
import { SexoService } from 'app/entities/sexo/sexo.service';
import { Sexo } from 'app/shared/model/sexo.model';

describe('Component Tests', () => {
    describe('Sexo Management Component', () => {
        let comp: SexoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SexoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.sexos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
