...
import { TipoContratacaoComponent } from 'app/entities/tipo-contratacao/tipo-contratacao.component';
...
describe('Component Tests', () => {
    describe('TipoContratacao Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tipoContratacaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
