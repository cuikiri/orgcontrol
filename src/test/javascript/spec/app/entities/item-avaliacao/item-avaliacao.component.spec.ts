...
import { ItemAvaliacaoComponent } from 'app/entities/item-avaliacao/item-avaliacao.component';
...
describe('Component Tests', () => {
    describe('ItemAvaliacao Management Component', () => {
        let comp: ItemAvaliacaoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ItemAvaliacaoComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ItemAvaliacaoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.itemAvaliacaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
