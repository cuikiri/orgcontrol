...
import { ColaboradorComponent } from 'app/entities/colaborador/colaborador.component';
...
describe('Component Tests', () => {
    describe('Colaborador Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.colaboradors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
