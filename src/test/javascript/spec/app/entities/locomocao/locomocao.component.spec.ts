...
import { LocomocaoComponent } from 'app/entities/locomocao/locomocao.component';
...
describe('Component Tests', () => {
    describe('Locomocao Management Component', () => {
        let comp: LocomocaoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(LocomocaoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.locomocaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
