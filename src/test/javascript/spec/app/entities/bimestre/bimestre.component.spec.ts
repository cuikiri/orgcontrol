...
import { BimestreComponent } from 'app/entities/bimestre/bimestre.component';
...
describe('Component Tests', () => {
    describe('Bimestre Management Component', () => {
        let comp: BimestreComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BimestreComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.bimestres[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
