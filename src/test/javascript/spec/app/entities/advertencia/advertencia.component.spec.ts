...
import { AdvertenciaComponent } from 'app/entities/advertencia/advertencia.component';
...
describe('Component Tests', () => {
    describe('Advertencia Management Component', () => {
        let comp: AdvertenciaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AdvertenciaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.advertencias[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
