...
import { BlocoComponent } from 'app/entities/bloco/bloco.component';
import { BlocoService } from 'app/entities/bloco/bloco.service';
import { Bloco } from 'app/shared/model/bloco.model';

describe('Component Tests', () => {
    describe('Bloco Management Component', () => {
        let comp: BlocoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BlocoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.blocos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
