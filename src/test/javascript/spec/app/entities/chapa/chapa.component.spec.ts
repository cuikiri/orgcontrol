...
import { ChapaComponent } from 'app/entities/chapa/chapa.component';
import { ChapaService } from 'app/entities/chapa/chapa.service';
import { Chapa } from 'app/shared/model/chapa.model';

describe('Component Tests', () => {
    describe('Chapa Management Component', () => {
        let comp: ChapaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ChapaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.chapas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
