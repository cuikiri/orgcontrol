...
import { TipoAvaliacaoComponent } from 'app/entities/tipo-avaliacao/tipo-avaliacao.component';
...
describe('Component Tests', () => {
    describe('TipoAvaliacao Management Component', () => {
        let comp: TipoAvaliacaoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TipoAvaliacaoComponent],
                providers: [
                    {
                ...
                .overrideTemplate(TipoAvaliacaoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tipoAvaliacaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
