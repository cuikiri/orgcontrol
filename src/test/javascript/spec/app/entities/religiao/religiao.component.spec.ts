...
import { ReligiaoComponent } from 'app/entities/religiao/religiao.component';
...
describe('Component Tests', () => {
    describe('Religiao Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.religiaos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
