...
public class EmailResourceIntTest {
    ...
    private static final TipoEmail DEFAULT_TIPO_EMAIL = TipoEmail.PESSOAL;
    private static final TipoEmail UPDATED_TIPO_EMAIL = TipoEmail.COMERCIAL;
    ...
    public void createEmail() throws Exception {
        ...
        assertThat(testEmail.getTipoEmail()).isEqualTo(DEFAULT_TIPO_EMAIL);
        assertThat(testEmail.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    @Test
    @Transactional
    public void checkTipoEmailIsRequired() throws Exception {
        int databaseSizeBeforeTest = emailRepository.findAll().size();
        // set the field null
        email.setTipoEmail(null);
    ...
    public void getAllEmails() throws Exception {
        ...
        restEmailMockMvc.perform(get("/api/emails?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tipoEmail").value(hasItem(DEFAULT_TIPO_EMAIL.toString())))
    ...
    public void getEmail() throws Exception {
        ...
        restEmailMockMvc.perform(get("/api/emails/{id}", email.getId()))
            ...
            .andExpect(jsonPath("$.tipoEmail").value(DEFAULT_TIPO_EMAIL.toString()))
    ...
    public void updateEmail() throws Exception {
        ...
        Email testEmail = emailList.get(emailList.size() - 1);
        assertThat(testEmail.getTipoEmail()).isEqualTo(UPDATED_TIPO_EMAIL);
        assertThat(testEmail.getDescricao()).isEqualTo(UPDATED_DESCRICAO);
    }
