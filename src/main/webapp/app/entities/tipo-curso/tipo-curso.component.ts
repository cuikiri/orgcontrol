...
export class TipoCursoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.tipoCursoService
            ...
            .subscribe(
                (res: HttpResponse<ITipoCurso[]>) => this.paginateTipoCursos(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/tipo-curso'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    private paginateTipoCursos(data: ITipoCurso[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.tipoCursos = data;
    }
