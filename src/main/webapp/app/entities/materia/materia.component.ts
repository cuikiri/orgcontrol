...
export class MateriaComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.materiaService
            ...
            .subscribe(
                (res: HttpResponse<IMateria[]>) => this.paginateMaterias(res.body, res.headers),
    ...
    trackId(index: number, item: IMateria) {
        return item.id;
    }
    ...
    private paginateMaterias(data: IMateria[], headers: HttpHeaders) {
