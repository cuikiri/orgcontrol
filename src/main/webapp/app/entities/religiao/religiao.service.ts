...
type EntityResponseType = HttpResponse<IReligiao>;
type EntityArrayResponseType = HttpResponse<IReligiao[]>;

@Injectable({ providedIn: 'root' })
export class ReligiaoService {
    public resourceUrl = SERVER_API_URL + 'api/religiaos';
    ...
    update(religiao: IReligiao): Observable<EntityResponseType> {
        return this.http.put<IReligiao>(this.resourceUrl, religiao, { observe: 'response' });
    }
