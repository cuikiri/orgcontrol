...
export class BlocoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.blocoService
            ...
            .subscribe(
                (res: HttpResponse<IBloco[]>) => this.paginateBlocos(res.body, res.headers),
    ...
    trackId(index: number, item: IBloco) {
        return item.id;
    }
    ...
    private paginateBlocos(data: IBloco[], headers: HttpHeaders) {
