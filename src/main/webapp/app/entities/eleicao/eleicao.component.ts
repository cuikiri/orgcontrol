...
export class EleicaoComponent implements OnInit, OnDestroy {
    ...
    registerChangeInEleicaos() {
        this.eventSubscriber = this.eventManager.subscribe('eleicaoListModification', response => this.loadAll());
    }
    ...
    private paginateEleicaos(data: IEleicao[], headers: HttpHeaders) {
