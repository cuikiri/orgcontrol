...
export class AvaliacaoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.avaliacaoService
            ...
            .subscribe(
                (res: HttpResponse<IAvaliacao[]>) => this.paginateAvaliacaos(res.body, res.headers),
    ...
    trackId(index: number, item: IAvaliacao) {
        return item.id;
    }
    ...
    private paginateAvaliacaos(data: IAvaliacao[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.avaliacaos = data;
    }
