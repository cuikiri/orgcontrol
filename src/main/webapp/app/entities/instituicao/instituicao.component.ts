...
export class InstituicaoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.instituicaoService
            ...
            .subscribe(
                (res: HttpResponse<IInstituicao[]>) => this.paginateInstituicaos(res.body, res.headers),
    ...
    private paginateInstituicaos(data: IInstituicao[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        this.queryCount = this.totalItems;
        this.instituicaos = data;
    }
