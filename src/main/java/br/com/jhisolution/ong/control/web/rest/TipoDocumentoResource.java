...
public class TipoDocumentoResource {
    ...
    @Timed
    public ResponseEntity<List<TipoDocumento>> getAllTipoDocumentos(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("documento-is-null".equals(filter)) {
            log.debug("REST request to get all TipoDocumentos where documento is null");
            return new ResponseEntity<>(tipoDocumentoService.findAllWhereDocumentoIsNull(),
                    HttpStatus.OK);
        }
